					...
					<form method="post" action="<?= site_url('irigasi/add');?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="alasanPerubahanJadwalLelangUlang" class="form-control">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Alasan Gagal Lelang 2</label>
                            <input type="text" class="form-control" name="alasanGagalLelang2">
                          </div>
                          <div class="form-group">
                    ...
                    <div class="col-lg-6 col-md-6 cols-sm-12">
                        <div class="form-group">
						  ...
						  <div class="form-group" style="margin-top: 30px;">
                            ...
                            <input type="text" name="alasanPerubahanJadwal" class="form-control">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Alasan Gagal Lelang</label>
                            <input type="text" name="alasanGagalLelang1" class="form-control">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="alasanSPPBJUndur" class="form-control">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Alasan SPK diundur</label>
                            <input type="text" name="alasanSPKUndur" class="form-control">
                          </div>
                    </div>
                    </div>
                    <div class="form-group">
